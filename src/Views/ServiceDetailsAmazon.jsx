...
function ServiceDetailsAmazon(props) {
    ...
    return (
        <>
            <div className="inner_pages_wrapper amazon_service">
                <Header class_bg='black_bg' />

                <Loader show={loading} />
                <Helmet>
                    <title>{metaData?.data?.meta_title}</title>
                    <link rel="canonical" href="https://www.mucheco.com/amazon-services" />
                                ...
                                <div className="text-wrapper" data-aos="fade-right" data-aos-duration="1000">
                                    <div className="experience-box wow fadeInLeft">
                                        ...
                                        <div className="content">
                                           ...
                                           {detailsData?.data?.readmore?.lis.length>0?
                                           <ul className="check-list list-circle-bg mb-20 wow fadeInUp absolute_check">
                                                {detailsData?.data?.readmore?.lis?.map((each,i) => (
                                                    <li key={i}>{each}</li>
                                                ))}
              ...
              <video id="mainVideo" autoPlay muted loop style={{width:'100%'}}>
    ...
    Your browser does not support the video tag.
                ...
                <section className="features-area position-relative mb-90-minus" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    {/* <div className="container">
                        <div className="row">
                            <div className="col-md-2 col-6 counter-column">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-2 col-6 counter-column">
                                <div className="counter_column_inn">
                                    <div className="counter_icon">
                                        <img src={require("../image/service_details/01.png")} alt="" />
                                    </div>
                                    <div className="counter-item">
                                        <h2 className="number"><span className="count count-num">{detailsData?.data?.liveCount[0].count}</span></h2>
                                        <p>{detailsData?.data?.liveCount[0].title}</p>
                            ...
                            <div className="col-md-2 col-6 counter-column">
                                <div className="counter_column_inn">
                                    <div className="counter_icon">
                                        <img src={require("../image/service_details/02.png")} alt="" />
                                    </div>
                                    <div className="counter-item">
                                        <h2 className="number"><span className="count count-num">{detailsData?.data?.liveCount[1].count}</span></h2>
                                        <p>{detailsData?.data?.liveCount[1].title}</p>
                            ...
                            <div className="col-md-2 col-6 counter-column">
                                <div className="counter_column_inn">
                                    <div className="counter_icon">
                                        <img src={require("../image/service_details/03.png")} alt="" />
                                    </div>
                                    <div className="counter-item">
                                        <h2 className="number"><span className="count count-num">{detailsData?.data?.liveCount[2].count}</span></h2>
                                        <p>{detailsData?.data?.liveCount[2].title}</p>
                            ...
                            <div className="col-md-2 col-6 counter-column">
                                <div className="counter_column_inn">
                                    <div className="counter_icon">
                                        <img src={require("../image/service_details/04.png")} alt="" />
                                    </div>
                                    <div className="counter-item">
                                        <h2 className="number"><span className="count count-num">{detailsData?.data?.liveCount[3].count}</span></h2>
                                        <p>{detailsData?.data?.liveCount[3].title}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-2 col-6 counter-column">
                                <div className="counter_column_inn">
                                    <div className="counter_icon">
                                        <img src={require("../image/service_details/05.png")} alt="" />
                                    </div>
                                    <div className="counter-item">
                                        <h2 className="number"><span className="count count-num">{detailsData?.data?.liveCount[4].count}</span></h2>
                                        <p>{detailsData?.data?.liveCount[4].title}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="features-area light-gray-bg pt-150 pb-100">
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="block-style-twenty d-flex mb-30 wow fadeInUp" data-aos="fade-up" data-aos-duration="500">
                                    <div className="icon">
                          ...
                          <div className="row justify-content-left">
                            <div className="col-lg-12">
                                <div className="section-title mb-20">
                                    <span className="sub-title sub-title-bg blue-light-bg">what we do</span>
                                    <h2 className="">{detailsData?.data?.what_we_do.title}</h2>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-lg-12">
                                  {detailsData?.data?.what_we_do?.lis.length>0?<ul className="check-list list-circle-bg mb-20 wow fadeInUp absolute_check">
                                    {detailsData?.data?.what_we_do?.lis?.map((each,i) => (
                                        // <li key={i}>{each}</li>
                                        <li key={i} dangerouslySetInnerHTML={{__html:each}}/>
                                    ))}
                                                {/* <li>{detailsData?.data?.readmore?.lis[0]}</li>
                                                <li>{detailsData?.data?.readmore?.lis[1]}</li>
                                                <li>{detailsData?.data?.readmore?.lis[2]}</li>
                                             ...
                                             <p dangerouslySetInnerHTML={{__html: detailsData?.data?.what_we_do?.description}}></p>
                            </div>
                        </div>
                    </div>
                </section>
...
{/* Start service section */}
    <section className="features-area service_section_wrapper pt-150 pb-100">
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-lg-6">
                                <div className="section-title text-center mb-50 wow fadeInUp" data-aos="fade-up" data-aos-duration="1000">
                                    <span className="sub-title sub-title-bg blue-light-bg">Our Service</span>
                                    <h2 className="">{detailsData?.data?.our_services}</h2>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-lg-4">
                                <div className="block-style-twenty  mb-30 wow fadeInUp" data-aos="fade-up" data-aos-duration="500">
                                   <div className='each_service_border'>
                                    <div className="icon_head_wrap d-flex">
                                    <div className="icon">
                                      
                                        <img src={require("../image/flaticon-help.png")} alt="" />
                                    </div>
                                    <div className="text">
                                        <h3 className="">{detailsData?.data?.our_services_title[0].title}</h3>
                                        
                                    </div>
                                    </div>
                                    <p  dangerouslySetInnerHTML={{__html:detailsData?.data?.our_services_title[0].desc_short}}/>
                                    <button className='service_readmore' onClick={() => { showFullImageHandle(detailsData?.data?.our_services_title[0].description) }}>Read more ...</button>
                                </div>
                                </div>
                            </div>
                            <div className="col-lg-4">
                                <div className="block-style-twenty mb-30 wow fadeInUp" data-aos="fade-up" data-aos-duration="700">
                                      <div className='each_service_border'>
                                     <div className="icon_head_wrap d-flex">
                                    <div className="icon">
                                    ...
                                    <div className="text">
                                        <h3 className="">{detailsData?.data?.our_services_title[1].title}</h3>
                                        
                                    </div>
                                    </div>
                                    <p  dangerouslySetInnerHTML={{__html:detailsData?.data?.our_services_title[1].desc_short}}/>
                                     <button className='service_readmore' onClick={() => { showFullImageHandle(detailsData?.data?.our_services_title[1].description) }}>Read more ...</button>
                                </div>
                                </div>
                            </div>
                            <div className="col-lg-4">
                                <div className="block-style-twenty mb-30 wow fadeInUp" data-aos="fade-up" data-aos-duration="700">
                                    ...
                                    <div className="text">
                                        <h3 className="">{detailsData?.data?.our_services_title[2].title}</h3>
                                        
                                    </div>
                                    </div>
                                    
                                    <p  dangerouslySetInnerHTML={{__html:detailsData?.data?.our_services_title[2].desc_short}}/>
                                     <button className='service_readmore' onClick={() => { showFullImageHandle(detailsData?.data?.our_services_title[2].description) }}>Read more ...</button>
                                </div>
                                </div>
                            </div>
                            <div className="col-lg-4">
                                <div className="block-style-twenty mb-30 wow fadeInUp" data-aos="fade-up" data-aos-duration="900">
                                       <div className='each_service_border'>
                                     <div className="icon_head_wrap d-flex">
                                    <div className="icon">
                                    ...
                                    <div className="text">
                                        <h3 className="">{detailsData?.data?.our_services_title[3].title}</h3>
                                        
                                    </div>
                                    </div>
                                    <p  dangerouslySetInnerHTML={{__html:detailsData?.data?.our_services_title[3].desc_short}}/>
                                     <button className='service_readmore' onClick={() => { showFullImageHandle(detailsData?.data?.our_services_title[3].description) }}>Read more ...</button>
                               </div>
                                </div>
                            </div>
                            <div className="col-lg-4">
                                <div className="block-style-twenty mb-30 wow fadeInUp" data-aos="fade-up" data-aos-duration="900">
                                    ...
                                    <div className="text">
                                        <h3 className="">{detailsData?.data?.our_services_title[4].title}</h3>
                                     
                                    </div>
                                    </div>
                                       <p  dangerouslySetInnerHTML={{__html:detailsData?.data?.our_services_title[4].desc_short}}/>
                                        <button className='service_readmore' onClick={() => { showFullImageHandle(detailsData?.data?.our_services_title[4].description) }}>Read more ...</button>
                                </div>
                                </div>
                            </div>
                            <div className="col-lg-4">
                                <div className="block-style-twenty mb-30 wow fadeInUp" data-aos="fade-up" data-aos-duration="900">
                                    ...
                                    <div className="text">
                                        <h3 className="">{detailsData?.data?.our_services_title[5].title}</h3>
                                     
                                    </div>
                                    </div>
                                       <p  dangerouslySetInnerHTML={{__html:detailsData?.data?.our_services_title[5].desc_short}}/>
                                        <button className='service_readmore' onClick={() => { showFullImageHandle(detailsData?.data?.our_services_title[5].description) }}>Read more ...</button>
                                </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="fancy-text-block light-gray-bg fancy-text-block-eleven pt-130 pb-80">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-6">
                            ...
                            <div className="col-lg-6">
                                <div className="text-wrapper mb-50">
                                    <div className="section-title mb-25 wow fadeInUp" data-aos="fade-up" data-aos-duration="1000">
                                        ...
                                        <p  dangerouslySetInnerHTML={{__html:detailsData?.data?.why_choose?.description}}/>
                                    </div>

                                    {detailsData?.data?.why_choose?.lis.length>0?<ul className="check-list list-circle-bg mb-20 wow fadeInUp" data-aos="fade-up" data-aos-duration="1000">
                                       {detailsData?.data?.why_choose?.lis?.map((each,i) => (
                                         <li key={i}>{each}</li>
                                       ))}
 ...
 {(fullImgUrl) ? (<div className="image-popup custom_popup">
                ...
                <div className='popup_inner_content'>
                    <p dangerouslySetInnerHTML={{__html:fullImgUrl}}/>
                </div>
                </div>
                </div>
            ) : ''}
...
export default ServiceDetailsAmazon;